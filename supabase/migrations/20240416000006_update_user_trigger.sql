-- Atualizar a função de trigger para buscar dados do user_metadata
CREATE OR REPLACE FUNCTION public.handle_new_user()
RETURNS trigger AS $$
BEGIN
  -- Inserir na tabela perfis com dados do user_metadata
...
VALUES (
    ...
    jsonb_build_object(
        ...
        'action', 'update',
        'changes', array['Atualizado para usar raw_user_metadata', 'Adicionado logging de erros']
    ),
    'sucesso',
    'Função de trigger atualizada com sucesso'
); 